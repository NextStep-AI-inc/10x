...
| 9. Release-Build End-to-End Acceptance | recorded with blocked physical acceptance | `09a3215` | `bfd9a22` | Whole-branch code review approved | Exact-head gates pass: OmpKit 165 with 2 expected skips, app tests 218, universal Release build, and visible Release PID 28227. Older OMP 18.0.4 gating passed in the real settings UI; AeroSpace, Hammerspoon, and Background Only live agent runs remain FAIL/not run because required local prerequisites were unavailable. |
